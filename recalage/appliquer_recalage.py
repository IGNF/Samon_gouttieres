...
def association(bati_goutieres, bati_bd_uni, geoseries):
    ...
    for b_uni in bati_bd_uni:
        ...
        if geoserie.intersects(b_uni.polygon).any():
            ...
            b_uni.iou_hull = bati_homologue.iou_hull
...
def sauvegarde_projection(bati_bd_uni, output, input_BD_Uni):
    ...
    d = {"nb_points":nb_points, "mean":mean, "res_max":res_max, "cleabs":id_origine, "geometry": polygones, "iou_hull":iou_hull}
