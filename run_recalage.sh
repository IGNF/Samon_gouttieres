...
python recalage/association_bati_BD_UNI.py --input_gouttieres ${repertoire_goutiere}/intersections_ajustees/intersections_ajustees.shp --input_BD_Uni ${repertoire_goutiere}/BD_Uni_regroupee/BD_TOPO.gpkg --output ${repertoire_goutiere}/association_bati_BD_Uni
