...
import numpy as np
from v2.samon.ortho import Ortho
from v2.samon.orthoLocale import OrthoLocale
from typing import List, Tuple
from shapely.geometry import LineString, Point
import geopandas
from v2.samon.tool import print_log, save_image
from v2.samon.correlation_engine import CorrelationEngine
from v2.samon.epipolarGeometry import EpipolarGeometry
...
class Chantier:
    ...
    def __init__(self, point: Point, resolution: float, projet, type_correlation="pvaGeomEpip", sauvegarde=False):
        self.point = point
        self.id = Chantier.id_global
        Chantier.id_global += 1
    ...
    def create_small_ortho(self):
        ...
        self.small_bd_ortho = Ortho(self.resolution, self.projet.size_small_bd_ortho, os.path.join(self.path, "bd_ortho"), centre=self.point)
